...
def main():
  ...
  parser.add_argument('--size_filter',help="INT,INT i.e. 0,1000 only count annotations with transcript lengths in this range 0 and 1000 included.")
  ...
  parser.add_argument('--filter',help='FILENAME  newline delimited list of annotations.  Limit rarefraction curve to this subset of possible annotations.')
