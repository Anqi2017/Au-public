...
# Input: .bax.h5 or .bas.h5 file name, output base name, accuracy (integer between zero and 100)
...
if(scalar(@ARGV) != 4) { die "<infile> <out base name> <accuracy i.e. 90> <min full passes> \n"; }
